...
const tests = [
  ...
  testPublicPerformanceSummaryUsesDelayedSevenDayWindow,
  testPublicPerformanceSummaryIsEmptyWithoutDatabase,
  testPublicSignalLedgerExcludesObservationsAndHidesDirectionalOutcomes,
